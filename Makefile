...
ROLES := $(filter-out __% README.md,$(wildcard roles/*))
PLUGIN_TYPES := $(filter-out __% README.md,$(notdir $(wildcard plugins/*)))
METADATA := galaxy.yml LICENSE README.md meta/runtime.yml requirements.txt meta/execution-environment.yml .ansible-lint .yamllint
